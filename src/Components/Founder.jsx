...
const Founder = () => {
  return (
    ...
    <div className='flex    flex-col             md:flex-row items-center justify-center mt-5'>
      ...
      <h1 className='text-[#1D3C49] text-3xl font-bold mb-2'>Lakshay Bansal</h1>
      <p className='text-[#2B5A6E] text-sm md:text-base '>After a decade of indulging his darkest vices as a nightclub promoter, Lakshay declared spiritual, moral, and emotional bankruptcy. He spent two years on a hospital ship off the coast of Liberia, saw the effects of starvation over the people, and came back to India on a mission.</p>
    </div>
