...
const Founder = () => {
  return (
    ...
    <div className='flex    flex-col             md:flex-row items-center justify-center mt-5'>
      ...
      <h2 className='text-[#2B5A6E] text-xl font-bold mb-5'>Our Founder</h2>
      <h1 className='text-[#1D3C49] text-2xl font-bold mb-2'>Lakshay Bansal</h1>
      <p className='text-[#2B5A6E] text-sm '>After a decade of indulging his darkest vices as a nightclub promoter, Lakshay declared spiritual, moral, and emotional bankruptcy. He spent two years on a hospital ship off the coast of Liberia, saw the effects of starvation over the people, and came back to India on a mission.</p>
    </div>
