...
const About_work = () => {
  return (
    <div className='my-7 mx-4 md:mx-14 flex flex-col  justify-center mt-10 lg:mt-20'>
      <h1 className='text-[#1D3C49] text-3xl md:text-5xl font-bold text-center mb-10'>How we work</h1>
