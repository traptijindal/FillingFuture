  ...
  return (
    <div className='flex items-center justify-center min-h-screen mt-10'>
      <div className='w-[350px] shadow-lg shadow-[rgb(136,134,134)]  p-6'>
        <h1 className='text-[#002844] font-bold text-2xl text-center mb-6'>Sign up for <span className='text-[#FFA500]'>Filling</span>Future</h1>
        <input type="text" placeholder="Email"    className='pr-20 pl-5 py-2 ml-2 border border-[#BAC8CE] rounded-sm my-4 text-start'/>
      <input type="text" placeholder="Password" className='pr-20 pl-5 py-2 ml-2 border border-[#BAC8CE] rounded-sm   mb-4 text-start'/>
